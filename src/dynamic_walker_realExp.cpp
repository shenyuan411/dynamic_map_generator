...
double      x_l2,x_h2,y_l2,y_h2;
double      x_l3,x_h3,y_l3,y_h3;
double      x_l4,x_h4,y_l4,y_h4;
double      x_l5,x_h5,y_l5,y_h5;
...
//   ros::Subscriber obs1_pose_sub =n.subscribe<geometry_msgs::PoseWithCovarianceStamped>("/gazebo_actor1_pos", 100, obs1_pose_set_callback);
  ...
  n.param("obs1x_l", x_l1, 0.0);
  n.param("obs1x_h", x_h1, 0.0);
